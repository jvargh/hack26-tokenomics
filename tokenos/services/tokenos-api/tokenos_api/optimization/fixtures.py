...
PROMPT_FIXTURES = {
    "verbose_support_reply": {
        ...
        "inputs": {
            ...
            "desiredOutcome": "Produce a concise grounded customer reply with the applicable damaged-item remedy and citations.",
        ...
        "contextArtifacts": [
            {"filename": "returns-policy.md", "content": "# Damaged on arrival\nItems reported damaged within 14 days of delivery are eligible for replacement or refund after photo review. Cite policy DOA-14.\n\n# Standard returns\nUnused items may be returned within 30 days."},
